...
This repository contains the Core Platform API for the GPT-Line system.
...
This repository is responsible only for the Core API service and should not redefine cross-service contracts on its own.